...
//  });
  list<Feature*>::iterator feature_iterator;
  for (feature_iterator = new_features.begin(); feature_iterator != new_features.end(); feature_iterator++) {
    Seed seed(*feature_iterator, new_keyframe_mean_depth_, new_keyframe_min_depth_);
